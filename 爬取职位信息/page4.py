...
class caihaopage4:
    def __init__(self):
        ...
        self.pageStories = []
        self.url = 'http://www.xjhr.com/job/?JobType=1000&WorkPlace=0&Trade=0&Property=0&JobProperty=0&Degree=0&WorkYears=0&JobTag=0&Weal=0&MonthPay=0&PublishDate=90&Key=&Orderid=0&Styleid=1&PageNo=4'
